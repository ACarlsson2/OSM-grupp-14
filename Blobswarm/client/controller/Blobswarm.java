...
public class Blobswarm {
    public static void main(String[] args) {
        ...
        final BlobswarmController controller = new BlobswarmController(opt);
...
class ControllerOptions {
    ...
    private char rightPlayerUp = 'a';
    private char rightPlayerDown = 'd';
...
class BlobswarmController implements KeyListener {
    ...
    private final BlobswarmView view;
    private final BlobswarmModel model;

    public BlobswarmController(final ControllerOptions opt) {
        this.options = opt;
        this.model = new myBlobswarmModel(options.getLeftPlayer(), options.getRightPlayer());
        this.view = new BlobswarmView(model);
